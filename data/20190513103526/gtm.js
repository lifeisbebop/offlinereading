...
"resource": {
  ...
  "rules":[
    [["if",0],["add",0,6,11,19,15,16,17,18]],
    [["if",0,1],["add",1,7,20]],
    [["if",0,2],["add",1,20]],
    [["if",0,3],["add",2]],
    [["if",4],["add",3]],
...
1)),g=Math.min(h,g))}if(void 0!==g&&0>=g)return!0;(d=d.parentElement)&&(e=f.getComputedStyle(d,null))}return!1};var sh=f.clearTimeout,th=f.setTimeout,G=function(a,b,c){if(Ie()){b&&z(b)}else return Na(a,b,c)},uh=function(){return new Date},vh=function(){return f.location.href},wh=function(a){return db(eb(a),"fragment")},xh=function(a){return cb(eb(a))},yh=function(a,b){return id(a,b||2)},zh=function(a,b,c){b&&(a.eventCallback=b,c&&(a.eventTimeout=c));return Ve(a)},Ah=function(a,b){f[a]=b},K=function(a,b,c){b&&(void 0===f[a]||
...
V.a.ctv=["google"],function(){(function(a){V.__ctv=a;V.__ctv.g="ctv";V.__ctv.h=!0;V.__ctv.b=0})(function(){return"51"})}();
V.a.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(w){for(var A=[],B=w.split(","),C=0;C<B.length;C++){var D=Number(B[C]);if(isNaN(D))return[];n.test(B[C])||A.push(D)}return A}function c(){var w=0,A=0;return function(){var B=ih(),C=B.height;w=Math.max(v.scrollLeft+B.width,w);A=Math.max(v.scrollTop+C,A);return{sf:w,tf:A}}}function d(){q=K("self");
r=q.document;v=r.scrollingElement||r.body&&r.body.parentNode;y=c()}function e(w,A,B,C){var D=l(A),H={},S;for(S in D){H.la=S;if(D.hasOwnProperty(H.la)){var T=Number(H.la);w<T||(zh({event:"gtm.scrollDepth","gtm.scrollThreshold":T,"gtm.scrollUnits":B.toLowerCase(),"gtm.scrollDirection":C,"gtm.triggers":D[H.la].join(",")}),If("sdl",A,function(W){return function(P){delete P[W.la];return P}}(H),{}))}H={la:H.la}}}function g(){var w=y(),A=w.sf,B=w.tf,C=A/v.scrollWidth*100,D=B/v.scrollHeight*100;e(A,"horiz.pix",
p.qb,t.md);e(C,"horiz.pct",p.pb,t.md);e(B,"vert.pix",p.qb,t.qd);e(D,"vert.pct",p.pb,t.qd);Hf("sdl","pending",!1)}function h(){var w=250,A=!1;r.scrollingElement&&r.documentElement&&q.addEventListener&&(w=50,A=!0);var B=0,C=!1,D=function(){C?B=th(D,w):(B=0,g(),Gh("sdl")&&!a()&&(Ta(q,"scroll",H),Ta(q,"resize",H),Hf("sdl","init",!1)));C=!1},H=function(){A&&y();B?C=!0:(B=th(D,w),Hf("sdl","pending",!0))};return H}function k(w,A,B){if(A){var C=b(String(w));If("sdl",B,function(D){for(var H=0;H<C.length;H++){var S=
String(C[H]);D.hasOwnProperty(S)||(D[S]=[]);D[S].push(A)}return D},{})}}function l(w){return Jf("sdl",w,{})}function m(w){z(w.vtp_gtmOnSuccess);var A=w.vtp_uniqueTriggerId,B=w.vtp_horizontalThresholdsPixels,C=w.vtp_horizontalThresholdsPercent,D=w.vtp_verticalThresholdUnits,H=w.vtp_verticalThresholdsPixels,S=w.vtp_verticalThresholdsPercent;switch(w.vtp_horizontalThresholdUnits){case p.qb:k(B,A,"horiz.pix");break;case p.pb:k(C,A,"horiz.pct")}switch(D){case p.qb:k(H,A,"vert.pix");break;case p.pb:k(S,
A,"vert.pct")}Gh("sdl")?Jf("sdl","pending")||(x||(d(),x=!0),z(function(){return g()})):(d(),x=!0,v&&(Hh("sdl"),Hf("sdl","pending",!0),z(function(){g();if(a()){var T=h();Sa(q,"scroll",T);Sa(q,"resize",T)}else Hf("sdl","init",!1)})))}var n=/^\s*$/,p={pb:"PERCENT",qb:"PIXELS"},t={qd:"vertical",md:"horizontal"},q,r,v,x=!1,y;(function(w){V.__sdl=w;V.__sdl.g="sdl";V.__sdl.h=!0;V.__sdl.b=0})(function(w){w.vtp_triggerStartOption?m(w):Se(function(){m(w)})})}();
...
else try{G("//bat.bing.com/bat.js",function(){var h=Ph(K("UET"),{ti:b.vtp_tagId,q:d});f[c]=h;h.push("pageLoad");b.vtp_gtmOnSuccess()},b.vtp_gtmOnFailure),a=!0}catch(h){z(b.vtp_gtmOnFailure)}})}();



V.a.hid=["google"],function(){(function(a){V.__hid=a;V.__hid.g="hid";V.__hid.h=!0;V.__hid.b=0})(function(){return Cf.ob})}();
